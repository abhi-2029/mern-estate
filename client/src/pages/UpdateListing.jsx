...
export default function UpdateListing() {
  ...
  // ✅ Fetch listing details for prefill
  useEffect(() => {
    const fetchListing = async () => {
      try {
        ...
        setError('Something went wrong while fetching listing');
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <p className="text-center my-7 text-2xl text-slate-600">
